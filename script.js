...
function printTurno() {
    const contenido = `
        ...
        <p>Presente este comprobante al llegar al taller.</p>
    `;
    ...
    if (turno) {
        ...
        switch(turno.estado) {
            case 'pendiente':
                ...
                break;
            case 'en revision':
                estadoElement.classList.add('estado-revision');
                break;
            case 'en reparacion':
                estadoElement.classList.add('estado-reparacion');
                break;
            case 'terminado':
